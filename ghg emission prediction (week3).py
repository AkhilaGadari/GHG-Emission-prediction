...
years[0]
df_2 = pd.read_excel(r'C:\Users\aakhi\Desktop\SupplyChainEmissionFactorsforUSIndustriesCommodities.xlsx', sheet_name=f'{years[0]}_Detail_Industry')
df_2.head()
df_2 = pd.read_excel(
    r'C:\Users\aakhi\Desktop\SupplyChainEmissionFactorsforUSIndustriesCommodities.xlsx',
    sheet_name=f'{years[0]}_Detail_Industry'
)

df_2.head()
excel_file = r'C:\Users\aakhi\Desktop\SupplyChainEmissionFactorsforUSIndustriesCommodities.xlsx'
years = range(2010, 2017)
